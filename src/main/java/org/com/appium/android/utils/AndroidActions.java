...
public class AndroidActions  {
	...
	public void Drag_Drop(WebElement drag_element )
	{
		...
		// Java
		((JavascriptExecutor) driver).executeScript("mobile: dragGesture", ImmutableMap.of("elementId", ((RemoteWebElement) drag_element).getId(),
		    "endX", 650,
		    "endY", 560,
		    "speed", 200
		));
	...
	public void swipe_gesture (WebElement  element_to_be_swiped,String direction)
	{
		...
		//Java
			((JavascriptExecutor) driver).executeScript("mobile: swipeGesture", ImmutableMap.of("elementId",((RemoteWebElement)element_to_be_swiped).getId(),"direction", direction,"percent", 0.5));
	...
	public void LongPressGesture(   WebElement element_to_be_pressed_for_long,int forHowlong)
	{
	         ...
	         ((JavascriptExecutor) driver).executeScript("mobile: longClickGesture", ImmutableMap.of("elementId", ((RemoteWebElement) element_to_be_pressed_for_long).getId(),"duration",forHowlong));
	}
